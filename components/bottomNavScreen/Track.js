...
import HomeHeadNav from '../HomeScreen/HomeHeadNav'
import BottomNav from '../../screens/BottomNav'
import { btn1, btn2, colors } from '../../components/HomeScreen/global/style'
...
const Track = ({ navigation }) => {
    ...
    const cancelOrder = (orderitem) => {
        const orderRef = firestore().collection('UserOrders').doc(orderitem.orderid);
        orderRef.update({
